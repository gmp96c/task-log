...
describe('Tip works in mode', () => {
    ...
    test('Base', () => {
        const element = render(<Tips task={testTask} mode="Base" />);
        ...
        const tiplessElement = render(<Tips task={tiplessTask} mode="Base" />);
    ...
    test('Settings', () => {
        ...
        const openTipDialogButton = element.container.querySelector('.openTipDialog');
        expect(openTipDialogButton).not.toBeNull();

        const tiplessElement = render(<Tips task={tiplessTask} mode="Settings" />);
