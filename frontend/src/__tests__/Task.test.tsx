...
test('loads and displays task', async () => {
    ...
    const addLogButtonB = querySelector('.logControls')?.childNodes[0];
    const viewLogsButtonB = querySelector('.logControls')?.childNodes[1];
    ...
    const addLogButtonS = querySelector('.logControls')?.childNodes[0];
    const viewLogsButtonS = querySelector('.logControls')?.childNodes[1];
    const removeTaskButtonS = querySelector('.logControls')?.childNodes[2];
